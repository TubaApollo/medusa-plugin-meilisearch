import { ProductDTO, ProductCategoryDTO, SearchTypes } from '@medusajs/types'
...
export type ProductIndexSettings = Omit<SearchTypes.IndexSettings, 'transformer'> & {
  type: 'products'
  enabled?: boolean
  fields?: string[]
...
export type CategoryIndexSettings = Omit<SearchTypes.IndexSettings, 'transformer'> & {
  type: 'product_categories'
  enabled?: boolean
  fields?: string[]
  indexSettings: Settings
  transformer?: CategoryTransformer<Record<string, any>>
}
...
export interface MeilisearchPluginOptions {
   ...
   */
  settings?: {
    [key: string]: ProductIndexSettings | CategoryIndexSettings
  }
