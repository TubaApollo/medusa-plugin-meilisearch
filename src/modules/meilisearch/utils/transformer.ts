...
export const transformCategory: (category: ProductCategoryDTO, options?: TransformOptions) => Record<string, unknown> = (category: ProductCategoryDTO, options?: TransformOptions) => {
  const {
    i18n,
    language,
    fallbackLanguage,
